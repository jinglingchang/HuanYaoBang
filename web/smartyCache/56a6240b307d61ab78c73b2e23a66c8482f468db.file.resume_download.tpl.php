<?php /* Smarty version Smarty-3.0-RC2, created on 2016-05-11 18:24:55
         compiled from "/Users/shanhaokun/Desktop/Lev/Sites/employer_tool/Lib/Resume/Tpl/Resume/resume_download.tpl" */ ?>
<?php /*%%SmartyHeaderCode:60556755357330877d901b5-38291624%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '56a6240b307d61ab78c73b2e23a66c8482f468db' => 
    array (
      0 => '/Users/shanhaokun/Desktop/Lev/Sites/employer_tool/Lib/Resume/Tpl/Resume/resume_download.tpl',
      1 => 1462962293,
    ),
  ),
  'nocache_hash' => '60556755357330877d901b5-38291624',
  'function' => 
  array (
  ),
...
上传</span>
            ...
            <!-- <?php if ($_smarty_tpl->getVariable('resume_operation_status')->value==1){?>

                <?php if ($_smarty_tpl->getVariable('resume_info')->value->resume_secret==0){?>
                    <img class="suo-img" src="<?php echo $_smarty_tpl->getVariable('WebSiteUrlPublic')->value;?>
/image/iconfont-suokai.png" style="width: 20px;margin-left: 10px;" />
                    <span class="set-resume-open" style="cursor: pointer; color: #3398ff" >已公开</span>

                <?php }else{ ?>
                    <img class="suo-img" src="<?php echo $_smarty_tpl->getVariable('WebSiteUrlPublic')->value;?>
/image/iconfont-suoguan.png" style="width: 20px;margin-left: 10px;" />
                    <span class="set-resume-open" style="cursor: pointer; color: #888" >已保密</span>
                <?php }?>
...
岁）
                ...
                <tr>
                    <td>
                            ...
                            <?php if ($_smarty_tpl->getVariable('resume_info')->value->resume_info['work_status']==0){?>

                            <div class="resume-status resume-status-not resume-checked2" id='resume_status_1' style="margin-left: 50px;">
                                观望
                                </div>
                            ...
                            <?php }elseif($_smarty_tpl->getVariable('resume_info')->value->resume_info['work_status']==1){?>

                            <div class="resume-status resume-checked2" id='resume_status_1' style="margin-left: 50px;">
                                有意向
                                </div>
            ...
            <div class="review_contact_div">
                ...
                <div class="review_contact_score_div">
                    ...
                    <?php if ($_smarty_tpl->getVariable('resume_operation_status')->value==1){?>
                                ...
                                <!-- <?php if ($_smarty_tpl->getVariable('type')->value=='upload'||$_smarty_tpl->getVariable('type')->value=='buy'||$_smarty_tpl->getVariable('position_id')->value==''){?>
                                    <div id="myStat2" data-dimension="250" data-text="<?php echo $_smarty_tpl->getVariable('resume_info')->value->resume_complete_score;?>
%" data-info="" data-width="30" data-fontsize="24" data-percent="<?php echo $_smarty_tpl->getVariable('resume_info')->value->resume_complete_score;?>
" data-fgcolor="#3398ff" data-bgcolor="#e1e1e1">
                                    </div>

                                    <script>$('#myStat2').circliful();</script>
                                <?php }else{ ?>
                                    <div id="myStat2" data-dimension="250" data-text="<?php echo $_smarty_tpl->getVariable('resume_info')->value->score;?>
" data-info="" data-width="30" data-fontsize="50" data-percent="<?php echo $_smarty_tpl->getVariable('resume_info')->value->score;?>
" data-fgcolor="#00c7ff" data-bgcolor="#d0f5ff">
                                    </div>
                                <?php }?>
                            ...
                            <button onclick='javascript:window.location.href = "<?php echo $_smarty_tpl->getVariable('websiteUrl')->value;?>
resume/edit?id=<?php echo $_smarty_tpl->getVariable('resume_id')->value;?>
"' class="btn btnStandard" id='editResumeButton' style=" margin-top: 15px;">编辑简历</button>

                            <?php }else{ ?>

                            <button class="btn btnStandard" id='editResumeButton' style=" margin-top: 15px;visibility: hidden">编辑简历</button>
