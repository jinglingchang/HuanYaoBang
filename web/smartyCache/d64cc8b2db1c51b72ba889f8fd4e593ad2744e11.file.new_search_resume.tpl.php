<?php /* Smarty version Smarty-3.0-RC2, created on 2016-05-16 20:20:48
         compiled from "/Users/shanhaokun/Desktop/Lev/Sites/employer_tool/Lib/Resume/Tpl/Resume/new_search_resume.tpl" */ ?>
<?php /*%%SmartyHeaderCode:247372945739bb20abb8a2-31793630%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd64cc8b2db1c51b72ba889f8fd4e593ad2744e11' => 
    array (
      0 => '/Users/shanhaokun/Desktop/Lev/Sites/employer_tool/Lib/Resume/Tpl/Resume/new_search_resume.tpl',
      1 => 1463401246,
    ),
  ),
  'nocache_hash' => '247372945739bb20abb8a2-31793630',
  'function' => 
  array (
  ),
...
<div class="hl-warp_div" style="width: 1000px; min-height: auto;">
    ...
    <input type='hidden' name='default' id='default'  value='5'>

    <?php $_template = new Smarty_Internal_Template(($_smarty_tpl->getVariable('path')->value)."/multPage/filter.tpl", $_smarty_tpl->smarty, $_smarty_tpl, $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null);
 echo $_template->getRenderedTemplate();?><?php $_template->updateParentVariables(0);?><?php unset($_template);?>
    ...
    <div class="sort-row" id ="sort-row-id">
        ...
        <div id="dict_skill" style="width: 140px;" class="selectWrap">
            <div class="selectBtn" id="selectProvince" style="background: rgb(242,242,242);">
                <a class="default-val-buy-number resume_list_sort_list" id='resume_search_buy_number'>购买次数</a>
            </div>
            <ul style="display: none;" class="select_ul sort">
...
<input type='hidden' name='defaultSort' id='defaultSort' value='0' />


<?php $_template = new Smarty_Internal_Template(($_smarty_tpl->getVariable('path')->value)."/multPage/login.tpl", $_smarty_tpl->smarty, $_smarty_tpl, $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null);
 echo $_template->getRenderedTemplate();?><?php $_template->updateParentVariables(0);?><?php unset($_template);?>
