<?php /* Smarty version Smarty-3.0-RC2, created on 2016-05-16 17:24:37
         compiled from "/Users/shanhaokun/Desktop/Lev/Sites/employer_tool/Public/html//multPage/filter.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1980504723573991d59ef3c9-57770327%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '70f88354a922e57e5170f945bb0235209600551d' => 
    array (
      0 => '/Users/shanhaokun/Desktop/Lev/Sites/employer_tool/Public/html//multPage/filter.tpl',
      1 => 1463390178,
    ),
  ),
  'nocache_hash' => '1980504723573991d59ef3c9-57770327',
  'function' => 
  array (
  ),
...
<style type="text/css">
    ...
    <div style="margin-top: 10px;width: 85%; margin-left: auto;padding-top: 30px;">
        ...
        <div class="search-input-warp">
            <input type="text" id="search" name="search" value="<?php echo $_smarty_tpl->getVariable('keyword')->value;?>
...
<div style=""class="down-filter" >
    <div class="hl-resume-screen-row">
        ...
        <table class="hl-resume-screen-row-table">
            <tr>
                <td>
                    <div id="dict_skill" style="width: 100px;margin-left:25px;" class="selectWrap">
                        <div class="selectBtn minSelectBtn" id="selectProvince" style="background:#fff;height:30px;line-height:9px;margin-top: 3px;">
                            <a class="default-val-filter" id='min_education' style="font-size: 12px;white-space: nowrap;">最低学历</a>
                        </div>
                        <ul style="display: none;width: 100px;" class="sceen_ul select_ul  select_min_education">
                            <li val="0" onclick='selectScreen(this);' style="font-size: 12px;">大专以下
                            </li>
                            <li val="1" onclick='selectScreen(this);'style="font-size: 12px;">大专
                            </li>
                            <li val="2" onclick='selectScreen(this);'style="font-size: 12px;">本科
                            </li>

                            <li val="3"  onclick='selectScreen(this);'style="font-size: 12px;">硕士
                            </li>

                            <li val="4"  onclick='selectScreen(this);'style="font-size: 12px;">MBA/EMBA
                            </li>

                            <li val="5" onclick='selectScreen(this);' style="font-size: 12px;">博士
                            </li>

                        </ul>
                    </div>
                    <span style="color: #777;">—&nbsp;</span>
                    <div id="dict_skill"  style="width: 100px;" class="selectWrap">
                        <div class="selectBtn minSelectBtn" id="selectProvince" style="background: #fff;height: 30px;line-height: 9px;margin-top: 3px;">
                            <a class="default-val-filter" id='max_education'style="font-size: 12px;white-space: nowrap;">最高学历</a>
                        </div>
                        <ul style="display: none;width: 100px;" class="sceen_ul select_ul select_max_education">
            ...
            <tr>
                <td>
                    ...
                    <div id="dict_skill"  style="width: 100px; margin-right: 40px;" class="selectWrap">
                        <div class="selectBtn minSelectBtn" id="selectProvince" style="background: #fff;height: 30px;line-height: 9px;margin-top: 3px;margin-left: 40px;">
                            <a class="default-val-buy-filter" id='marries_select'style="font-size: 12px;">婚育</a>
                        </div>
                        <ul style="display: none; margin-left: 40px;width: 100px;" class="sceen_ul select_ul">
                            <li val="0" onclick='selectScreen(this);
