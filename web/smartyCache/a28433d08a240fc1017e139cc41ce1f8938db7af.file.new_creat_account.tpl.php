<?php /* Smarty version Smarty-3.0-RC2, created on 2016-06-27 10:52:30
         compiled from "/private/var/www/html/employer_tool/Lib/User/Tpl/User/new_creat_account.tpl" */ ?>
<?php /*%%SmartyHeaderCode:796089763577094eeaccd39-78506577%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a28433d08a240fc1017e139cc41ce1f8938db7af' => 
    array (
      0 => '/private/var/www/html/employer_tool/Lib/User/Tpl/User/new_creat_account.tpl',
      1 => 1466420145,
    ),
  ),
  'nocache_hash' => '796089763577094eeaccd39-78506577',
  'function' => 
  array (
  ),
...
'>
			...
			<div class="page-title-div" style='margin-bottom: 0px;'>创建账号</div>

			<div style='margin-top: 5px;margin-bottom: 20px;text-align: center;font-size: 14px;'>注册后并完成任务，即可获得奖励<span class='defaultColor'>230</span>元</div>
...
<!-- 		                <li val="0">个人</li>-->		            
			...
			<div class="row-height-div">
				<input type="password" class="new-open-account-input pwdVal" name="password"  placeholder="请设置6位以上密码" />
			</div>
			<div style="width:320px;text-align: left;margin: 0 auto;font-size: 16px;margin-top: 20px;">请验证您的手机</div>
