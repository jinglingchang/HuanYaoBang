<?php /* Smarty version Smarty-3.0-RC2, created on 2016-06-08 11:46:58
         compiled from "/private/var/www/html/employer_tool/Lib/Resume/Tpl/Resume/resume_detail.tpl" */ ?>
<?php /*%%SmartyHeaderCode:178307147957579532e21d31-09052208%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5e6840392eb0e0d1a16fbe8def47b8de11db566f' => 
    array (
      0 => '/private/var/www/html/employer_tool/Lib/Resume/Tpl/Resume/resume_detail.tpl',
      1 => 1465357597,
    ),
  ),
  'nocache_hash' => '178307147957579532e21d31-09052208',
  'function' => 
  array (
  ),
...
岁）
                ...
                <tr>
                    ...
                    <div style="white-space: nowrap;">
                        ...
                        <?php if ($_smarty_tpl->getVariable('resume_info')->value->salary!=''){?>
                            &nbsp;&nbsp;&nbsp;&nbsp;
                            薪资评估建议：<?php echo $_smarty_tpl->getVariable('resume_info')->value->salary;?>
            ...
            <div class="review_contact_div">
                ...
                <div class="review_contact_score_div">
                    ...
                    <div style='width:176px;height:82px;margin:0 auto;margin-top: 36px;display:none' id='buyed_operation' class='resume-detail-left-area'>

                        <span style='font-size: 20px;color:#6AA8FB;text-align: center;'>简历价格&nbsp;<?php echo $_smarty_tpl->getVariable('resume_info')->value->resume_info['price'];?>
元</span>

                        <span style='font-size: 12px;color:#888888;text-align: center;margin-top: 30px;display: inline-block;'>
                    ...
                    <div id='buy_operation' style='width:176px;height:82px;margin:0 auto;margin-top: 36px;display:none;' class='resume-detail-left-area'>

                        <div style='width:101px;height: 32px;background-color: #3398ff;text-align: center;color:white;line-height: 32px;cursor:pointer;margin:0 auto;' onclick='buy_resume()' id='buy_resume_button'>打赏<?php echo $_smarty_tpl->getVariable('resume_info')->value->resume_info['price'];?>
元</div>
...
" data-fgcolor="#3398ff" data-bgcolor="#e1e1e1">
        ...
        <div class="tab_table_div" style='border-bottom: solid 1px #e1e1e1;margin-top:-30px;'>
           <!--  <table>
                <tr>
...
?>
                            <tr style="font-size: 15px;">
                                <td style="width:22%;text-align: left;vertical-align: -webkit-baseline-middle;padding-top: 10px;padding-left: 58px;">
                                    <div style='width: 140px;'><?php echo $_smarty_tpl->tpl_vars['info']->value['begin_times'];?>
                                ...
                                <td style="padding-left: 35px;">
                                    <div style="padding-top: 10px;">
                                        ...
                                        <?php if ($_smarty_tpl->tpl_vars['info']->value['project']!=''){?>
                                            <span style="display: block;white-space: nowrap;overflow: hidden; height: 30px;font-weight: bold;max-width:700px;">
...
'
        ...
        $('#buy_resume_button').mouseover(function(){

            $(this).css('background','#7CAFFB')

        })

        $('#buy_resume_button').mouseout(function(){
