<?php /* Smarty version Smarty-3.0-RC2, created on 2016-05-16 18:59:26
         compiled from "/Users/shanhaokun/Desktop/Lev/Sites/employer_tool/Lib/User/Tpl/User/user_account_page.tpl" */ ?>
<?php /*%%SmartyHeaderCode:12842494035739a80e5d78b7-77966629%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3a91aab2b52519333ab0b58b04bc56a4a0322a2a' => 
    array (
      0 => '/Users/shanhaokun/Desktop/Lev/Sites/employer_tool/Lib/User/Tpl/User/user_account_page.tpl',
      1 => 1463396363,
    ),
  ),
  'nocache_hash' => '12842494035739a80e5d78b7-77966629',
  'function' => 
  array (
  ),
...
'</script>
 ...
 echo $_template->getRenderedTemplate();?><?php $_template->updateParentVariables(0);?><?php unset($_template);?>
    ...
    <div class="hl-warp_div" style="width: 1000px; background: rgb(240,240,240);">
...
/image/authu.png"/ style="width: 28px;margin-top: -6px;"> 已实名认证
        ...
        <div style=" border:solid 1px #e1e1e1;margin-top: 15px; margin-bottom: 15px; background: #fff;min-height: 125px;">
            <div style=" padding-left: 50px; height: 61px; line-height: 61px;">
                账户余额
            </div>
            <div style=" padding-left: 50px; margin-top: -5px;">
                <span style="font-size: 24px;color:red; font-family: Arial; display: block;width: 150px;float: left;">
...
元
                ...
                <button style=" width: 100px;background: #3398ff;border: none;color: #fff;font-size: 16px;height: 35px;cursor: pointer;margin-left: 50px;margin-top: 10px;" onclick="jumpPay()">
                    充&nbsp;&nbsp;&nbsp;&nbsp;值
                </button>
...
<button class="withdraw-button" style="width: 100px;background: #fff;color: #666;font-size: 16px;height: 35px;cursor: pointer;margin-left: 52px;margin-top: 10px;border: solid 1px #e1e1e1;" onclick="$('.authenticationDg').show();">
        提&nbsp;&nbsp;&nbsp;&nbsp;现
    </button>

<?php }else{ ?>

<button class="withdraw-button" style="width: 100px;background: #fff;color: #666;font-size: 16px;height: 35px;cursor: pointer;margin-left: 52px;margin-top: 10px;border: solid 1px #e1e1e1;" onclick='window.open("<?php echo $_smarty_tpl->getVariable('websiteUrl')->value;?>
user/withdraw")'>
                    提&nbsp;&nbsp;&nbsp;&nbsp;现
                </button>
