        ...
        {foreach from=$list item=datas key=key}
            <tr>
                ...
                <td>
                    ...
                    {if $datas.hospital_type == 1}

                        一级甲等

                    {elseif $datas.hospital_type == 2}

                        二级甲等

                    {elseif $datas.hospital_type == 3}

                        三级甲等

                    {elseif $datas.hospital_type == 4}

                        私立医院

                    {elseif $datas.hospital_type == 5}
                ...
                <td>
                    <a href="pageredirst.php?action=hospital&functionname=edit&id={$datas.id}">编辑</a>
                </td>
            </tr>
        {/foreach}
    </table>
