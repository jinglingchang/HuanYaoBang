...
<body class='boby'>
    ...
    border: 1px solid #d9dadc; width: 98% ; margin: 0 auto;height: 1000px;'>
            ...
            <div style='float: left;height: 1000px; width: 82.5%;background-color: white;'>
                <iframe frameborder='0' src="{$WEBSITEPUBLIC}/html/mainfra.html" name="mainFrame" id="mainFrame" title="mainFrame" style='height: 1000px; width: 100%;background-color: white;'></iframe>
            </div>
        </div>
