<?php /* Smarty version Smarty-3.0-RC2, created on 2016-08-25 13:23:08
         compiled from "/web/www/HuanYaoBang/admin/Tpl/website/add_hospital_info.tpl" */ ?>
<?php /*%%SmartyHeaderCode:55243970957be80bc7e46f8-87061201%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'dd04a3f51710cc48950983272ab867a3fbdef618' => 
    array (
      0 => '/web/www/HuanYaoBang/admin/Tpl/website/add_hospital_info.tpl',
      1 => 1472093729,
    ),
  ),
  'nocache_hash' => '55243970957be80bc7e46f8-87061201',
  'function' => 
  array (
  ),
...
" alt="..." class="img-thumbnail" style='width:150px;'>
    ...
    <div class="form-group">
        ...
        <?php if ($_smarty_tpl->getVariable('operation_type')->value==1){?>
            <img src="http://localhost/HuanYaoBang/web/Public/upload/<?php echo $_smarty_tpl->getVariable('data')->value['zs_name'];?>
" alt="..." class="img-thumbnail" style='width:150px;'>
        <?php }?>
